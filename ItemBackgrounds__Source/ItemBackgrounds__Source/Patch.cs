...
namespace ItemBackgrounds
{
    public static class MainClass
    {
        ...
        public static BackgroundType Purple = BackgroundTypeHandler.AddBackgroundType("Purple", Sprites.Purple);
        public static BackgroundType Red = BackgroundTypeHandler.AddBackgroundType("Red", Sprites.Red);
        public static BackgroundType White = BackgroundTypeHandler.AddBackgroundType("White", Sprites.White);
        public static BackgroundType Yellow = BackgroundTypeHandler.AddBackgroundType("Yellow", Sprites.Yellow);
        ...
        public const string Tooltip = "Note: Items in inventory need to be refreshed by putting them in any storage and pulling them back out. For items in storage, close then re-open the container. (if it was originally opened)";
        ...
        public static void PatchResources()
        {
            ...
            Logger.Log(Logger.Level.Info, "Default");
